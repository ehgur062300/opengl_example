...
bool Context::Init() {
  ...
  float vertices[] = {
      0.5f, 0.5f, 0.0f, 0.5f, 0.5f, 0.0f, // top right, red
      0.5f, -0.5f, 0.0f, 0.5f, 0.5f, 0.0f, // bottom right, green
     -0.5f, -0.5f, 0.0f, 0.0f, 0.5f, 0.5f, // bottom left, blue
     -0.5f, 0.5f, 0.0f, 0.5f, 0.0f, 0.0f, // top left, yellow
};
